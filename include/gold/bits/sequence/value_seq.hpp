...
namespace gold {
    ...
    namespace __value_seq {
        ...
        template <__value_seq::qualified_value_seq Seq>
            requires requires { typename gold::constant_arg_t<Seq::template homogeneous<>>; }
        ...
        template <__value_seq::qualified_value_seq Seq>
            requires requires { typename gold::constant_arg_t<Seq::template empty<>>; }
    ...
    struct value_seq_t {
      ...
      public:
        ...
        /// ::fill_t
        template <auto N>
        using fill_t = value_seq_t<gold::conditional_t<true, gold::constant_arg_t<N>, gold::constant_arg_t<Ns>>::value...>;
