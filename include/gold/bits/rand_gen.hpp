...
namespace gold {
    ...
    class random_number_generator {
      ...
      private:
        engine_type m_generator_ { std::random_device{}() };
      ...
      public:
        ...
        void reseed(const typename engine_type::result_type& n = std::random_device{}()) {
            m_generator_.seed(n);
        }

        /// get_engine
        engine_type& get_engine() { return m_generator_; }
