...
namespace gold {
    ...
    /// character_type
    template <typename T>
    concept character_type = is_character_type_v<T>;

    /// ordering_type
    template <typename T>
    concept ordering_type = is_ordering_type_v<T>;

    /// scalar_numeric_type [defined in <gold/bits/concepts/scalar_numeric_type.hpp>]
    ...
    /// structural_type
    template <typename T>
    concept structural_type = is_structural_type_v<T>;
